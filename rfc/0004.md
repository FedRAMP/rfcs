...
Services which do not meet the above criteria should be excluded from the
...
The full draft policy is approximately 6 pages and is available for review as
follows:
...
- [PDF file: name.pdf](https://github.com/FedRAMP/rfc0004-boundary-policy/tree/main/rfc/assets)
- [Word file: name.docx](https://github.com/FedRAMP/rfc0004-boundary-policy/tree/main/rfc/assets)
...
comment to clearly highlight where and how this guidance can be clarified in
...
1. This policy explicitly limits the FedRAMP boundary to a subset of the full
   ...
   how can this be standardized clearly without examples?
...
2. This draft introduces the plain language idea of “handling” federal
   ...
   dispose, etc., etc., etc.”). Is this sufficiently clear?
...
3. FRR211: This rule is intended to convey that restrictions on external
   ...
   under this rule. This is difficult to convey and comment on improving clarity
