...
Providers MUST persistently ensure their *FedRAMP Security Inbox* receives email messages from .gov emails without any disruption, including meeting ALL of the following requirements when receiving an email originating from a .gov email address:
